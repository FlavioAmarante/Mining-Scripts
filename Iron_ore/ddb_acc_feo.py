...
def ddb_acc_feo(df1,varbreak,brk):
    ...
    df.loc[mask, 'afe3o4_1'] = (np.nan_to_num(df.loc[mask, 'fe3o4_1'] * df.loc[mask, 'g1'])  )
    ...
    df.loc[mask, 'afe3o4_2'] = (np.nan_to_num(df.loc[mask, 'fe3o4_2'] * df.loc[mask, 'g2'])  )
    ...
    df.loc[mask, 'afe3o4_3'] = (np.nan_to_num(df.loc[mask, 'fe3o4_3'] * df.loc[mask, 'g3'])  )
    ...
    df.loc[mask, 'afe3o4_4'] = (np.nan_to_num(df.loc[mask, 'fe3o4_4'] * df.loc[mask, 'g4'])  )
